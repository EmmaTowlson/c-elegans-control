...
## the sensory neuron set can be changed to:
## sensor = ['PLML','PLMR'] for posterior gentle touch
...
# build the linking graph of the connectome, including the muscles
H = nx.DiGraph()
depth = 120
## note that the depth should be large enough (at least larger than the
## number of target nodes, i.e. here the number of muscles.
## After simple tests, we find that depth = 120 is far enough for
## assessing muscle controllability.
